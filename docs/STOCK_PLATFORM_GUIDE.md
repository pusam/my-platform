...
**phase 36**: BULL 폭 ±0.20 → ±0.10 으로 좁힘 + 신규 진입 페널티 BULL 스킵.
**phase 37**: phase 36 후에도 sector 4점 병목 → `scoreSectorMomentum` 안에서 BULL regime 일
때 +4 일괄 boost (phase 31b 부분 복원) + BULL sector multiplier 1.00 → 1.20.
