...
| 2026-08-28 | 실적 분기소스 전환 (R1) | 조정 | 켬(quarterly-source=true). 커버리지 2,289종목 · TURNAROUND 209→103(연속 적자 조건으로 한 분기 삐끗 106건 제거) · POSITIVE 625 · NEGATIVE 610 · 임계 ±20% 미변경 | **이 날짜가 측정 표본의 경계** — 이전 표본과 섞지 말 것. 임계 재조정은 forward 성과 확보 후, 재판정일 2026-10-05 |
